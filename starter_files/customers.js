...
function createProfile() {
        ...
        ${people.map(customerProfile => `
            <div class="customer_profile">
                <img src="${customerProfile.picture.large}"><li>${customerProfile.name.title}${customerProfile.name.first}${customerProfile.name.last}</li>
                <li>${customerProfile.email}</li>
                <li>${customerProfile.location.street}</li>
                <li>${customerProfile.location.city}, ${customerProfile.location.state}${customerProfile.location.postcode}</li>
